...
export const CATEGORIES = ['Syllabus', 'Books', 'Previous Papers', 'Notes'];
...
export const SUBCATEGORIES: Record<string, string[]> = {
  ...
  'Previous Papers': [
    'Group 1', 'Group 2', 'Group 2A', 'Group 4',
...
export const DEMO_FILES: FileItem[] = [
  ...
  { id: '5', title: '10th Standard Tamil Book', description: 'Tamil textbook for 10th standard', category: 'Books', subcategory: '10th Standard', file_name: 'tamil-10th.pdf', file_path: '/demo/tamil-10th.pdf', download_count: 189, view_count: 340, created_at: '2024-01-20', file_size: 15000000, isVisible: true },
  { id: '6', title: '12th Standard Science Book', description: 'Science textbook for 12th standard', category: 'Books', subcategory: '12th Standard', file_name: 'science-12th.pdf', file_path: '/demo/science-12th.pdf', download_count: 156, view_count: 280, created_at: '2024-01-25', file_size: 18000000, isVisible: true },
  { id: '7', title: 'Group 2 Previous Paper 2023', description: 'Previous year question paper', category: 'Previous Papers', subcategory: 'Group 2', file_name: 'group2-2023.pdf', file_path: '/demo/group2-2023.pdf', download_count: 312, view_count: 560, created_at: '2024-02-01', file_size: 1800000, isVisible: true },
  { id: '8', title: 'Group 1 Previous Paper 2023', description: 'Previous year question paper for Group 1', category: 'Previous Papers', subcategory: 'Group 1', file_name: 'group1-2023.pdf', file_path: '/demo/group1-2023.pdf', download_count: 287, view_count: 490, created_at: '2024-02-05', file_size: 2100000, isVisible: true },
  { id: '9', title: 'General Studies Notes', description: 'Comprehensive GS notes', category: 'Notes', subcategory: 'General Studies', file_name: 'gs-notes.pdf', file_path: '/demo/gs-notes.pdf', download_count: 156, view_count: 320, created_at: '2024-02-10', file_size: 5200000, isVisible: true },
  { id: '10', title: 'Tamil Grammar Notes', description: 'Complete Tamil grammar notes', category: 'Notes', subcategory: 'Tamil', file_name: 'tamil-grammar.pdf', file_path: '/demo/tamil-grammar.pdf', download_count: 134, view_count: 275, created_at: '2024-02-12', file_size: 3800000, isVisible: true },
  { id: '11', title: 'History Notes - Freedom Struggle', description: 'Indian freedom struggle notes', category: 'Notes', subcategory: 'History', file_name: 'history-freedom.pdf', file_path: '/demo/history-freedom.pdf', download_count: 98, view_count: 210, created_at: '2024-02-18', file_size: 4200000, isVisible: false },
];
