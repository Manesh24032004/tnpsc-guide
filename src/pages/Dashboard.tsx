      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 animate-slide-up">
            <h3 className="text-2xl font-bold text-primary mb-4">What is TNPSC?</h3>
          ...
          <Card className="p-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-primary">TNPSC Exam Groups</h3>
            </div>
            <p className="text-muted-foreground mb-4">
            ...
            <div className="space-y-4">
              {eligibilityCriteria.map((criteria, index) => (
                <div key={index} className="p-4 bg-muted rounded-lg">
                  <h4 className="font-bold text-foreground mb-3 text-lg border-b border-accent/30 pb-2">
                    {criteria.group}
                  </h4>
              ...
              {selectionProcess.map((process, index) => (
                <div key={index} className="p-4 bg-muted rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-bold text-foreground text-lg">{process.group}</h4>
                  </div>
